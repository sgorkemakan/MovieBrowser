...
export const Header = () => {
  ...
  return (
    <header>
      <nav className="bg-white border-b-2 border-gray-200 p-2 sm:px-4 dark:bg-gray-900 dark:border-b-1 dark:border-gray-900">
        <div className="flex flex-wrap justify-between items-center mx-auto px-5">
